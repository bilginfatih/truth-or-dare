...
class MediumMaleSelectedChallenge extends StatelessWidget {
  String type;
  int i;
  MediumMaleSelectedChallenge({Key? key, required this.type, required this.i}) : super(key: key);
            ...
            children: [
              ...
              Expanded(
                child: Container(
                  ...
                  child: Text(
                    type == 'Orta Dogruluk' ? mediumMaleTruth[i] : mediumMaleDare[i],
