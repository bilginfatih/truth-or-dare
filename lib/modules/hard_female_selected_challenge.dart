...
class HardFemaleSelectedChallenge extends StatelessWidget {
  String type;
  int i;
  HardFemaleSelectedChallenge({Key? key, required this.type, required this.i}) : super(key: key);
            ...
            children: [
              ...
              Expanded(
                child: Container(
                  ...
                  child: Text(
                    type == 'Zor Dogruluk' ? hardFemaleTruth[i] : hardFemaleDare[i],
