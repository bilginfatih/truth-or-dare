...
class EasyMaleSelectedChallenge extends StatelessWidget {
  String type;
  int i;
  EasyMaleSelectedChallenge({Key? key, required this.type, required this.i}) : super(key: key);
            ...
            children: [
              ...
              Expanded(
                child: Container(
                  ...
                  child: Text(
                    type == 'Kolay Dogruluk' ? easyTrurhMale[i] : easyDareMale[i],
